...
docker-image:
	docker build -f ./input_boundary/Dockerfile -t "input_gateway:latest" .
	docker build -f ./output_boundary/Dockerfile -t "output_gateway:latest" .
	...
	docker build -f ./docktor/Dockerfile -t "docktor:latest" .
