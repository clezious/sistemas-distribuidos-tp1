...
class DecadeCounter:
    def __init__(self, input_queues: dict, output_queues: list):
        ...
        self.middleware = Middleware(input_queues, self.add_decade, output_queues)
    ...
    def add_decade(self, ch, method, properties, body):
        ...
        if len(self.authors[author]) == REQUIRED_DECADES:
            logging.info("Author %s has published books in %i different decades.", author, REQUIRED_DECADES)
